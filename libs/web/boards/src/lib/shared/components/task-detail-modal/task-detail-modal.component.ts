...
import { BoardList, CardEvent, DataLoading, DataLoadingState, Task, User, UserDetails } from '@planza/api-interfaces';
import { API_TOKEN, AssetUrlPipe, ToastService, UserAvatarGroupData, userMapToArray } from '@planza/web/ui';
...
@Component({
  selector: 'planza-task-detail-modal',
