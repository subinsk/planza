...
import { CardEvent } from '@planza/api-interfaces';
import { UserAvatarGroupData, userMapToArray } from '@planza/web/ui';
...
@Component({
  selector: 'planza-projects-create-modal',
  template: `
    <planza-modal
        ...
        <form [formGroup]="projectForm" id="projectForm" class="max-w-xl" (ngSubmit)="handleFormSubmit()">
          ...
          <div class="form-group">
            ...
            <div class="flex items-center">
              <planza-user-avatar-group [data]="selectedMembers$ | async"></planza-user-avatar-group>
