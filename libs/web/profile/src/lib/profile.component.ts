...
import { formatUser, ToastService } from '@planza/web/ui';
import { UsersAction } from '@planza/web/users/state';
import { Store } from '@ngxs/store';

@Component({
  selector: 'planza-profile',
  template: `
    <planza-page-header title="Profile"></planza-page-header>
