...
import { Role } from '@planza/api-interfaces';
import { DialogRef } from '@ngneat/dialog';
import { Observable } from 'rxjs';

@Component({
  selector: 'planza-users-create-modal',
  template: ` <planza-modal title="Invite a user" [ref]="ref" cdkTrapFocus cdkTrapFocusAutoCapture>
    <section>
